	...
	<dl class="slogens">
	 ...
	 <div class="seller hide">
			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn"><!-- href="http://www.zxtaotao.cn/order/${item.id}.html" -->
							<a class="btn-append " id="InitCartUrl" href="http://cart.zxtaotao.cn/cart/${item.id}.html" clstag="shangpin|keycount|product|initcarturl">加入购物车<b></b></a>
					</div>
